...
# plot_labeled_decision_regions() that you can use to plot the decision 
# regions of a list containing two trained classifiers. You can type 
...
# Train RMSE: 5.15
#  the training error is roughly equal to the 10-folds CV error you obtained
...
# Iterate over the pre-defined list of classifiersifiers
...
### Bagging or bootstrap aggreggation
...
# Evaluate the(y test set RMSE
rmse_test = MSE(y_test, y_pred)**(1/2)

print('Test set RMSE of rf: {:.2f}'.format(rmse_test))
# Test set RMSE of rf: 51.97, smaller then rmse test from a single CART
...
# RMSE than the gradient boosting regressor (which was 52.065)
